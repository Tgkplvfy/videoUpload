...
class ServerRequest extends Message implements ServerRequestInterface
{
    ...
    public static function createFromEnvironment(Environment $environment)
    {
        ...
        if ($method === 'POST' &&
            in_array($request->getMediaType(), array('application/x-www-form-urlencoded', 'multipart/form-data'))
        ) {
     ...
     */
    public function __construct($method, UriInterface $uri, HeadersInterface $headers, array $cookies, array $serverParams, StreamInterface $body, array $uploadedFiles = array())
    {
